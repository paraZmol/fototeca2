...
class GalleryController extends Controller
{
    ...
    {
        // arbol de provincias con sus hijos recursivos para el sidebar geografico
        ...
        // colecciones especiales para el panel lateral
        $specialCollections = Category::where('slug', 'especiales')
            ->with(['children'])
            ->first();

        // todos los periodos historicos para la barra de filtros
