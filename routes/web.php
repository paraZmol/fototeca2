...
Route::get('/especiales', [SpecialsController::class, 'index'])->name('specials.index');
Route::get('/especiales/{slug}', [SpecialsController::class, 'show'])->name('specials.show');
Route::view('/nosotros', 'about.index')->name('about');

// rutas de autenticacion (acceso solo por URL, sin boton publico)
